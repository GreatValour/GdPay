...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	if ($('#stacks_in_1042').length){

		$('#stacks_in_1042 > .nav-bar-pro-spacer > .nav-bar-pro-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});

		// Auto detect active (.active) page
		// Site _MUST_ use Tidy Links for this to be used.
		$('#stacks_in_1042 ul.nav-bar-items li a').each(function (index){
		  if ($(this).attr('href') == "./") {
			$(this).addClass('active');
		  }
		});

		$('#stacks_in_1042 ul.nav-bar-drop-down-items li a').each(function (index){
			if ($(this).attr('href') == "./") {
			  $(this).addClass('active');
			}
		});
		...
		//
			...
			closestBanner = $('#stacks_in_1042').closest('.nav_pairing');
			
			$('#stacks_in_1042').prependTo(closestBanner);
			...
			var stickyOffset = $('#stacks_in_1042 .nav-bar-pro-wrapper').offset().top;
			...
			$(window).scroll(function(){
				var sticky = $('#stacks_in_1042 .nav-bar-pro-wrapper'),
		...
		$('#stacks_in_1042 .nav-bar-drop-down-toggle').click(function() {
			if ($("#stacks_in_1042 .nav-bar-drop-down").is(":visible") == true) { 
				TweenMax.to($('#stacks_in_1042 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y:0, x:0, scale: 1, rotation:0, rotationY:0, rotationX:0, opacity: 1 }, y: 30, x: 0, scale: 1.00, rotation: 0, rotationY:0, rotationX: 0, opacity: 0 , ease: Power3.easeOut},0).eventCallback("onComplete", function(){
					$("#stacks_in_1042 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'none'});
				});
			} else {
				$("#stacks_in_1042 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'block'});
				TweenMax.to($('#stacks_in_1042 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y: 30, x: 0, scale: 1.00, rotation:0, rotationY:0, rotationX: 0, opacity: 0 }, y:0, x:0, scale:1.0, rotation: 0, rotationY:0, rotationX: 0, opacity: 1 , ease: Power3.easeOut},0);
				
				
				TweenMax.staggerFromTo("#stacks_in_1042 .nav-bar-drop-down > ul > li", 0.30, {opacity:0, y: 40, x: 0, scale:1}, {delay: 0.05, opacity:1, y:0, x:0, scale:1, ease: Power3.easeOut}, 0.1);
		...
		$('#stacks_in_1042').click(function(event){
			event.stopPropagation();
		});


		$('#stacks_in_1042 a.drop-down-expand-parent').click(function(event) {
			event.preventDefault();
...
stacks.stacks_in_616_11 = {};
stacks.stacks_in_616_11 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;
// Can also be used with $(document).ready()
$(window).load(function() {
  

  $("#stacks_in_616_11 .flexslider")
    .fitVids()
    .flexslider({
      prevText: "",      
      nextText: "",
...
      useCSS: false,
      ...
        $("#stacks_in_616_11 .loading_indicator").remove();
      }
  });

  var slide_wrapper = $('#stacks_in_616_11 .flexslider ul.slides').find('> li:not(.clone)');

  var slide_count = slide_wrapper.length;
  var slide_thumb_width = (100 / slide_count);
  var slide_thumb_width = slide_thumb_width + "%";

  $('#stacks_in_616_11 .flex-control-thumbs > li').css({ 'width' : slide_thumb_width });

});

return stack;})(stacks.stacks_in_616_11);
stacks.stacks_in_616_27 = {};
stacks.stacks_in_616_27 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
	$('#stacks_in_616_27 .btn').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
	
});
return stack;})(stacks.stacks_in_616_27);
stacks.stacks_in_865_16 = {};
stacks.stacks_in_865_16 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_865_16 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_865_16);
stacks.stacks_in_865_20 = {};
stacks.stacks_in_865_20 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
  ...
  function roundCornersCorrectly() {
    var itemsHeight = $('#stacks_in_865_20 .vtabs-tab-menu').outerHeight();
    var contentHeight = $('#stacks_in_865_20 .vtabs-tab-content.active').outerHeight();

    if ( itemsHeight > contentHeight ) {
      $('#stacks_in_865_20 .vtabs-tab-menu .list-group > a:last-child').addClass('round-left-corner').removeClass('unround-left-corner');
    } else {
      $('#stacks_in_865_20 .vtabs-tab-menu .list-group > a:last-child').addClass('unround-left-corner').removeClass('round-left-corner');
    }
  }


  $('#stacks_in_865_20 > .vtabs-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});

  $('#stacks_in_865_20 .list-group.vtabs-items .list-group-item:first-child, #stacks_in_865_20 .vtabs-tab .vtabs-tab-content:first-child').addClass('active');

  $('#stacks_in_865_20 .match-height').matchHeight({
    property: 'min-height'
  });
  ...
  $("#stacks_in_865_20 .vtabs-tab-menu > .list-group>a").click(function(e) {
      e.preventDefault();
      $(this).siblings('a.active').removeClass("active");
      $(this).addClass("active");
      var index = $(this).index();
      $("#stacks_in_865_20 .vtabs-tab > .vtabs-tab-content").removeClass("active");
      $("#stacks_in_865_20 .vtabs-tab > .vtabs-tab-content").eq(index).addClass("active");
...
return stack;})(stacks.stacks_in_865_20);
stacks.stacks_in_865_116 = {};
stacks.stacks_in_865_116 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
  
});

return stack;})(stacks.stacks_in_865_116);
stacks.stacks_in_865_34 = {};
stacks.stacks_in_865_34 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
  
  	$('#stacks_in_865_34 > .foundry-image-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
  	$('#stacks_in_865_34 figure, .stacks_top').css({'overflow' : 'visible'});
  
});

return stack;})(stacks.stacks_in_865_34);
stacks.stacks_in_865_42 = {};
stacks.stacks_in_865_42 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
  
  	$('#stacks_in_865_42 > .foundry-image-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
  	$('#stacks_in_865_42 figure, .stacks_top').css({'overflow' : 'visible'});
  
});

return stack;})(stacks.stacks_in_865_42);
stacks.stacks_in_865_130 = {};
stacks.stacks_in_865_130 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
  
});

return stack;})(stacks.stacks_in_865_130);
stacks.stacks_in_865_133 = {};
stacks.stacks_in_865_133 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_865_133 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_865_133);
stacks.stacks_in_865_167 = {};
stacks.stacks_in_865_167 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_865_167 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_865_167);
stacks.stacks_in_865_213 = {};
stacks.stacks_in_865_213 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_865_213 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_865_213);
stacks.stacks_in_865_169 = {};
stacks.stacks_in_865_169 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_865_169 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_865_169);
stacks.stacks_in_865_232 = {};
stacks.stacks_in_865_232 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;

return stack;})(stacks.stacks_in_865_232);
stacks.stacks_in_865_233 = {};
stacks.stacks_in_865_233 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;/*!
...
$(function(){
	...
	// init Isotope
	$filterContainer = $('#stacks_in_865_233 .filter-items');
		...
		$filterContainer.isotope( 'on', 'layoutComplete', 
		  function( e, items ) {
			...
			if ( !$filterContainer.data('isotope').filteredItems.length ) {
				$('#stacks_in_865_233 .filter-no-results').fadeIn('slow');
	  		} else {
	  			$('#stacks_in_865_233 .filter-no-results').hide();
	  		}
...
return stack;})(stacks.stacks_in_865_233);
stacks.stacks_in_618_6 = {};
stacks.stacks_in_618_6 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_618_6 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_618_6);
stacks.stacks_in_618_8 = {};
stacks.stacks_in_618_8 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_8);
stacks.stacks_in_618_17 = {};
stacks.stacks_in_618_17 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;
// Can also be used with $(document).ready()
$(window).load(function() {
  

  $("#stacks_in_618_17 .flexslider")
    .fitVids()
    .flexslider({
      prevText: "",      
      nextText: "",
...
      useCSS: false,
      ...
      smoothHeight: true,
      start: function(slider){
        $("#stacks_in_618_17 .loading_indicator").remove();
      }
  });

  var slide_wrapper = $('#stacks_in_618_17 .flexslider ul.slides').find('> li:not(.clone)');

  var slide_count = slide_wrapper.length;
  var slide_thumb_width = (100 / slide_count);
  var slide_thumb_width = slide_thumb_width + "%";

  $('#stacks_in_618_17 .flex-control-thumbs > li').css({ 'width' : slide_thumb_width });

});

return stack;})(stacks.stacks_in_618_17);
stacks.stacks_in_618_21 = {};
stacks.stacks_in_618_21 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_21);
stacks.stacks_in_618_25 = {};
stacks.stacks_in_618_25 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_25);
stacks.stacks_in_618_29 = {};
stacks.stacks_in_618_29 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_618_29 > .container').parentsUntil('.stacks_top').css({'overflow' : 'hidden'});
		$('.stacks_top').css({'overflow' : 'hidden'});
	
});

return stack;})(stacks.stacks_in_618_29);
stacks.stacks_in_618_38 = {};
stacks.stacks_in_618_38 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_38);
stacks.stacks_in_618_42 = {};
stacks.stacks_in_618_42 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_42);
stacks.stacks_in_618_47 = {};
stacks.stacks_in_618_47 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_618_47 > .container').parentsUntil('.stacks_top').css({'overflow' : 'hidden'});
		$('.stacks_top').css({'overflow' : 'hidden'});
	
});

return stack;})(stacks.stacks_in_618_47);
stacks.stacks_in_618_56 = {};
stacks.stacks_in_618_56 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_56);
stacks.stacks_in_618_60 = {};
stacks.stacks_in_618_60 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_60);
stacks.stacks_in_618_64 = {};
stacks.stacks_in_618_64 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_618_64 > .container').parentsUntil('.stacks_top').css({'overflow' : 'hidden'});
		$('.stacks_top').css({'overflow' : 'hidden'});
	
});

return stack;})(stacks.stacks_in_618_64);
stacks.stacks_in_618_71 = {};
stacks.stacks_in_618_71 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_618_71 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_618_71);
stacks.stacks_in_618_73 = {};
stacks.stacks_in_618_73 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_618_73);
stacks.stacks_in_772_4 = {};
stacks.stacks_in_772_4 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
...
return stack;})(stacks.stacks_in_772_4);
stacks.stacks_in_772_8 = {};
stacks.stacks_in_772_8 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_772_8 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_772_8);
stacks.stacks_in_772_47 = {};
stacks.stacks_in_772_47 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_772_47 > #animation-element-stacks_in_772_47').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_772_47'), 1.00, {  delay: 0.50, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_772_47').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_772_47);
stacks.stacks_in_772_52 = {};
stacks.stacks_in_772_52 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_772_52 > #animation-element-stacks_in_772_52').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_772_52'), 1.00, {  delay: 1.20, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_772_52').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_772_52);
stacks.stacks_in_772_56 = {};
stacks.stacks_in_772_56 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_772_56 > #animation-element-stacks_in_772_56').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_772_56'), 1.00, {  delay: 1.90, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_772_56').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_772_56);