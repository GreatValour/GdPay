...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	if ($('#stacks_in_579').length){

		$('#stacks_in_579 > .nav-bar-pro-spacer > .nav-bar-pro-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});

		// Auto detect active (.active) page
		// Site _MUST_ use Tidy Links for this to be used.
		$('#stacks_in_579 ul.nav-bar-items li a').each(function (index){
		  if ($(this).attr('href') == "./") {
			$(this).addClass('active');
		  }
		});

		$('#stacks_in_579 ul.nav-bar-drop-down-items li a').each(function (index){
			if ($(this).attr('href') == "./") {
			  $(this).addClass('active');
			}
		});
		...
		//
			...
			closestBanner = $('#stacks_in_579').closest('.nav_pairing');
			
			$('#stacks_in_579').prependTo(closestBanner);
			...
			var stickyOffset = $('#stacks_in_579 .nav-bar-pro-wrapper').offset().top;
			...
			$(window).scroll(function(){
				var sticky = $('#stacks_in_579 .nav-bar-pro-wrapper'),
		...
		$('#stacks_in_579 .nav-bar-drop-down-toggle').click(function() {
			if ($("#stacks_in_579 .nav-bar-drop-down").is(":visible") == true) { 
				TweenMax.to($('#stacks_in_579 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y:0, x:0, scale: 1, rotation:0, rotationY:0, rotationX:0, opacity: 1 }, y: 30, x: 0, scale: 1.00, rotation: 0, rotationY:0, rotationX: 0, opacity: 0 , ease: Power3.easeOut},0).eventCallback("onComplete", function(){
					$("#stacks_in_579 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'none'});
				});
			} else {
				$("#stacks_in_579 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'block'});
				TweenMax.to($('#stacks_in_579 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y: 30, x: 0, scale: 1.00, rotation:0, rotationY:0, rotationX: 0, opacity: 0 }, y:0, x:0, scale:1.0, rotation: 0, rotationY:0, rotationX: 0, opacity: 1 , ease: Power3.easeOut},0);
				
				
				TweenMax.staggerFromTo("#stacks_in_579 .nav-bar-drop-down > ul > li", 0.30, {opacity:0, y: 40, x: 0, scale:1}, {delay: 0.05, opacity:1, y:0, x:0, scale:1, ease: Power3.easeOut}, 0.1);
		...
		$('#stacks_in_579').click(function(event){
			event.stopPropagation();
		});


		$('#stacks_in_579 a.drop-down-expand-parent').click(function(event) {
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
		...
		$('#stacks_in_328 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_19, #toggleButtonstacks_in_19").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_19, #toggleButtonstacks_in_19").addClass("togglePlusClosed");
	
	$(".toggleAll, #basics, .toggleTrigger_stacks_in_19, .basics").click(function(){
		$("#toggleContainer_stacks_in_19").slideToggle(400);
		$("#toggleWrapper_stacks_in_19, #toggleButtonstacks_in_19").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_19, #toggleButtonstacks_in_19").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#basics").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_33, #toggleButtonstacks_in_33").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_33, #toggleButtonstacks_in_33").addClass("togglePlusClosed");
	
	$(".toggleAll, #interchange, .toggleTrigger_stacks_in_33, .interchange").click(function(){
		$("#toggleContainer_stacks_in_33").slideToggle(400);
		$("#toggleWrapper_stacks_in_33, #toggleButtonstacks_in_33").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_33, #toggleButtonstacks_in_33").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#interchange").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_88, #toggleButtonstacks_in_88").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_88, #toggleButtonstacks_in_88").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique1, .toggleTrigger_stacks_in_88, .unique1").click(function(){
		$("#toggleContainer_stacks_in_88").slideToggle(400);
		$("#toggleWrapper_stacks_in_88, #toggleButtonstacks_in_88").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_88, #toggleButtonstacks_in_88").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique1").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_103, #toggleButtonstacks_in_103").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_103, #toggleButtonstacks_in_103").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique3, .toggleTrigger_stacks_in_103, .unique3").click(function(){
		$("#toggleContainer_stacks_in_103").slideToggle(400);
		$("#toggleWrapper_stacks_in_103, #toggleButtonstacks_in_103").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_103, #toggleButtonstacks_in_103").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique3").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_116, #toggleButtonstacks_in_116").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_116, #toggleButtonstacks_in_116").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique4, .toggleTrigger_stacks_in_116, .unique4").click(function(){
		$("#toggleContainer_stacks_in_116").slideToggle(400);
		$("#toggleWrapper_stacks_in_116, #toggleButtonstacks_in_116").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_116, #toggleButtonstacks_in_116").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique4").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_159, #toggleButtonstacks_in_159").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_159, #toggleButtonstacks_in_159").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique5, .toggleTrigger_stacks_in_159, .unique5").click(function(){
		$("#toggleContainer_stacks_in_159").slideToggle(400);
		$("#toggleWrapper_stacks_in_159, #toggleButtonstacks_in_159").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_159, #toggleButtonstacks_in_159").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique5").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_205, #toggleButtonstacks_in_205").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_205, #toggleButtonstacks_in_205").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique6, .toggleTrigger_stacks_in_205, .unique6").click(function(){
		$("#toggleContainer_stacks_in_205").slideToggle(400);
		$("#toggleWrapper_stacks_in_205, #toggleButtonstacks_in_205").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_205, #toggleButtonstacks_in_205").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique6").click();
});
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	...
	$("#toggleWrapper_stacks_in_223, #toggleButtonstacks_in_223").removeClass("togglePlusOpened");
	$("#toggleWrapper_stacks_in_223, #toggleButtonstacks_in_223").addClass("togglePlusClosed");
	
	$(".toggleAll, #unique7, .toggleTrigger_stacks_in_223, .unique7").click(function(){
		$("#toggleContainer_stacks_in_223").slideToggle(400);
		$("#toggleWrapper_stacks_in_223, #toggleButtonstacks_in_223").toggleClass("togglePlusClosed");
		$("#toggleWrapper_stacks_in_223, #toggleButtonstacks_in_223").toggleClass("togglePlusOpened");
		
	});
	
	
	// Activate a toggle via a page anchor
	$("a[href='" + window.location.hash + "']").parent("#unique7").click();
});
...
stacks.stacks_in_380_8 = {};
stacks.stacks_in_380_8 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_380_8 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_380_8);
stacks.stacks_in_380_47 = {};
stacks.stacks_in_380_47 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_380_47 > #animation-element-stacks_in_380_47').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_380_47'), 1.00, {  delay: 0.50, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_380_47').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_380_47);
stacks.stacks_in_380_52 = {};
stacks.stacks_in_380_52 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_380_52 > #animation-element-stacks_in_380_52').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_380_52'), 1.00, {  delay: 1.20, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_380_52').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_380_52);
stacks.stacks_in_380_56 = {};
stacks.stacks_in_380_56 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_380_56 > #animation-element-stacks_in_380_56').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_380_56'), 1.00, {  delay: 1.90, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_380_56').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_380_56);