...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	if ($('#stacks_in_309').length){

		$('#stacks_in_309 > .nav-bar-pro-spacer > .nav-bar-pro-wrapper').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});

		// Auto detect active (.active) page
		// Site _MUST_ use Tidy Links for this to be used.
		$('#stacks_in_309 ul.nav-bar-items li a').each(function (index){
		  if ($(this).attr('href') == "./") {
			$(this).addClass('active');
		  }
		});

		$('#stacks_in_309 ul.nav-bar-drop-down-items li a').each(function (index){
			if ($(this).attr('href') == "./") {
			  $(this).addClass('active');
			}
		});
		...
		//
			...
			closestBanner = $('#stacks_in_309').closest('.nav_pairing');
			
			$('#stacks_in_309').prependTo(closestBanner);
			...
			var stickyOffset = $('#stacks_in_309 .nav-bar-pro-wrapper').offset().top;
			...
			$(window).scroll(function(){
				var sticky = $('#stacks_in_309 .nav-bar-pro-wrapper'),
		...
		$('#stacks_in_309 .nav-bar-drop-down-toggle').click(function() {
			if ($("#stacks_in_309 .nav-bar-drop-down").is(":visible") == true) { 
				TweenMax.to($('#stacks_in_309 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y:0, x:0, scale: 1, rotation:0, rotationY:0, rotationX:0, opacity: 1 }, y: 30, x: 0, scale: 1.00, rotation: 0, rotationY:0, rotationX: 0, opacity: 0 , ease: Power3.easeOut},0).eventCallback("onComplete", function(){
					$("#stacks_in_309 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'none'});
				});
			} else {
				$("#stacks_in_309 .nav-bar-drop-down").css({'opacity' : '0', 'display' : 'block'});
				TweenMax.to($('#stacks_in_309 .nav-bar-drop-down'), 0.20, { delay: 0.05, startAt:{ y: 30, x: 0, scale: 1.00, rotation:0, rotationY:0, rotationX: 0, opacity: 0 }, y:0, x:0, scale:1.0, rotation: 0, rotationY:0, rotationX: 0, opacity: 1 , ease: Power3.easeOut},0);
				
				
				TweenMax.staggerFromTo("#stacks_in_309 .nav-bar-drop-down > ul > li", 0.30, {opacity:0, y: 40, x: 0, scale:1}, {delay: 0.05, opacity:1, y:0, x:0, scale:1, ease: Power3.easeOut}, 0.1);
		...
		$('#stacks_in_309').click(function(event){
			event.stopPropagation();
		});


		$('#stacks_in_309 a.drop-down-expand-parent').click(function(event) {
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
		...
		$('#stacks_in_78 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
...
return stack;})(stacks.stacks_in_73_4);
stacks.stacks_in_73_8 = {};
stacks.stacks_in_73_8 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_73_8 > .container').parentsUntil('.stacks_top').css('overflow', 'visible');
		$('.stacks_top').css({'overflow' : 'visible'});
	
});

return stack;})(stacks.stacks_in_73_8);
stacks.stacks_in_73_47 = {};
stacks.stacks_in_73_47 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_73_47 > #animation-element-stacks_in_73_47').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_73_47'), 1.00, {  delay: 0.50, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_73_47').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_73_47);
stacks.stacks_in_73_52 = {};
stacks.stacks_in_73_52 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_73_52 > #animation-element-stacks_in_73_52').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_73_52'), 1.00, {  delay: 1.20, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_73_52').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_73_52);
stacks.stacks_in_73_56 = {};
stacks.stacks_in_73_56 = (function(stack) {
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function(){
	
		$('#stacks_in_73_56 > #animation-element-stacks_in_73_56').parentsUntil('.stacks_top').css({'overflow' : 'visible'});
		$('.stacks_top').css({'overflow' : 'visible'});
	...
	if (!isMobile) {
		...
		var offsetValue = ($(window).height() * 0.9);
						...
						TweenMax.to($('#animation-element-stacks_in_73_56'), 1.00, {  delay: 1.90, startAt:{rotation: 0, y:-50, x:0, scale:1.00, opacity:0.00, rotationY:0, rotationX:0}, scale:1, opacity:1.00, y:0, x:0, rotationY:0, rotationX:0, rotation:0, ease: Power3.easeOut }
			);
		...
		$('#animation-element-stacks_in_73_56').css({'opacity':'1'});

	}

});

return stack;})(stacks.stacks_in_73_56);